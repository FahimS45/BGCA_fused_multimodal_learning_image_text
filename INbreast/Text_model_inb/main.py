"""Main experiment script for Inbreast text classification."""

import torch
from transformers import BertTokenizer, BertForSequenceClassification, AdamW, get_linear_schedule_with_warmup
from config import Config
from utils import set_seed, filter_discriminative_words
...
def run_single_experiment(config: Config, seed: int):
    ...
    # Filter discriminative words
    texts_train_filtered, removed_words = filter_discriminative_words(
        texts_train, labels_train, config.discriminative_words_n
    )
    ...
    train_loader, val_loader, test_loader = create_dataloaders(
        texts_train_filtered, texts_val, texts_test,
