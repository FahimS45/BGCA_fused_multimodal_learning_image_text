...
from dataset import (load_and_preprocess_data, split_data, get_transforms, 
                    create_dataloaders)
from trainer import train_model, evaluate_model
from results import summarize_classification_results
...
def run_single_experiment(config: Config, seed: int, X, y):
    ...
    X_train, X_val, X_test, y_train, y_val, y_test = split_data(
        X, y, test_size=0.2, val_size=0.25, seed=seed
    )
